...
lib-linux:
	mkdir -p releases
	dotnet publish LibCloudCopy/src/ -c release -r $(linuxtarget) --self-contained  --framework $(dotnetrelease) --version-suffix "$(linuxtarget)"
...
linux:
	mkdir -p releases
	dotnet publish CloudCopyClient/src/ -c release -r $(linuxtarget) --self-contained --framework $(dotnetrelease) --version-suffix "$(linuxtarget)"
...
lib-windows:
	mkdir -p releases
	dotnet publish LibCloudCopy/src/ -c release -r $(windowstarget) --framework $(dotnetrelease) --no-self-contained --version-suffix "$(linuxtarget)"
...
windows:
	mkdir -p releases
	dotnet publish CloudCopyClient/src/ -c release -r $(windowstarget) --self-contained  --framework $(dotnetrelease) --version-suffix "$(linuxtarget)"
